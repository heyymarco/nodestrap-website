...
import { ComponentInfoProvider, CurrentComponent, LinkAccessibilitiesPage, SectionIntro } from '../../../components/common-contents'
...
const Page: NextPage = () => {
    return (
        <ComponentInfoProvider packageName='@nodestrap/accessibilities' packageType='utility' component={<LinkAccessibilitiesPage />} bases={<LinkAccessibilitiesPage />}>
            ...
            <Section title='Using the Accessibilities'>
                <p>
